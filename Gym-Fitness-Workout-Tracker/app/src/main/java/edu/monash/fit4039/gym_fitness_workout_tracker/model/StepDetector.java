...
/**
 * A step detector class which will accept updates from accelerometer sensor and deploys the filter
...
public class StepDetector {
    // The threshold according to your sensitivity preferences
    ...
    // A method to set up a step listener
    public void registerListener(StepListener listener) {
        this.listener = listener;
    }

    // Method to update value from accelerate sensor
